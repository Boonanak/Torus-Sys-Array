...
module mem_arbiter #(
    ...
    ,output logic [ADDR_W_lp-1:0]    wgt_w_addr_o
    ...
    assign psm_w_addr_o = ex_active_i ? ex_psm_w_addr_i: wr_addr_i;
    assign psm_w_data_o = ex_active_i ? ex_psm_w_data_i: wr_data_i;
    assign psm_r_v_o    = ex_active_i ? ex_psm_r_v_i   : rd_v_psm;
    assign psm_r_addr_o = ex_active_i ? ex_psm_r_addr_i: rd_addr_i;
