...
`endif
    ...
    always_comb begin
        ...
        IE[MOSI_PAD]       = 1'b1;
        IE[SS_N_PAD]       = 1'b1;
        for (k = 0; k < 17; k = k + 1) begin // Added increment to 17 for parity bit
...
`endif
    ...
    wire        link_rx_valid;
    wire        link_rx_yumi;
    wire        link_rx_parity; // added recieved parity bit
